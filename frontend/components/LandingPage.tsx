      ...
      <section className="bg-blue-600 py-16">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Sign up now and get instant analysis of your lease agreement. It's free, secure, and takes less than 2 minutes.
          </p>
          <button
            onClick={() => setShowLogin(true)}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <h1 className="text-2xl font-bold">Lexify</h1>
            </div>
            <p className="text-gray-400 mb-6">
              Empowering renters with AI-powered lease analysis and tenant rights assistance.
            </p>
            <div className="border-t border-gray-800 pt-6">
              <p className="text-gray-500 text-sm">
                © 2025 Lexify. Built to help renters understand their rights.
              </p>
            </div>
          </div>
        </div>
